...
public class PostServiceImpl implements PostService {
	...
	public List<Map<String, Object>> getPosts() {
		...
		var response= theRestTemplate.exchange(url,HttpMethod.GET,httpEntity,List.class);
		response.getBody();
	}
		...
		public Map<String, Object> getPostById(int id) {
			...
			var response=theRestTemplate.exchange(url,HttpMethod.GET,httpEntity,Map.class);
